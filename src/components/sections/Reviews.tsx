        ...
        >
          {reviewList.map((review) => (
            ...
            >
              <Card
                hoverEffect={true}
                className="bg-white rounded-3xl border border-border/80 p-6 shadow-premium hover:shadow-premium-lg flex flex-col h-full justify-between"
              >
                <div>
